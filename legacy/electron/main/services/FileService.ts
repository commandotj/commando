...
export default class FileService implements BaseService {
    ...
    async initialize(): Promise<void> {
        logger.info(
            "FileService initialized with comprehensive file operations"
        );
    }
    ...
    getMetadata(): ServiceMetadata {
        return {
            ...
            description:
                "Comprehensive file operations service with progress tracking",
        };
    }
        ...
        try {
            ...
            if (params.options?.sortBy) {
                results.sort((a, b) => {
                    ...
                    return params.options!.sortOrder === "desc"
                        ? -comparison
                        : comparison;
                });
            }
    ...
    private validateDeleteParams(params: DeleteParams): void {
        ...
        if (typeof params.permanent !== "boolean") {
            throw new Error(
                "Invalid delete parameters: permanent must be boolean"
            );
        }
    }
