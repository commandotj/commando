...
describe("ServiceDecorator", () => {
    ...
    beforeEach(() => {
        ...
        ;(ServiceRegistry as unknown as { instance: undefined }).instance = undefined
    ...
    describe("Service Registration", () => {
        it("should register a service with @Service decorator", () => {
            ...
            class TestService implements BaseService {
                ...
                sendLoadingState(_loading: boolean, _message?: string, _error?: boolean): void {
                    // Mock implementation
                }
                ...
                async handleAction(_event: IpcMainInvokeEvent, _params?: unknown): Promise<string> {
                    return "success"
                }
            }
