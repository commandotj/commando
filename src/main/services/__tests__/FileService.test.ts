...
describe('FileService', () => {
    ...
    beforeEach(() => {
        ...
        MockWorkerPool.getInstance.mockReturnValue(mockWorkerPool);
    ...
    describe('File Deletion', () => {
        ...
        it('should handle deletion errors', async () => {
            ...
            expect(result.failedFiles[0].error).toBe('Permission denied');
        });
    ...
    describe('File Rename', () => {
        ...
        it('should handle cross-directory renames', async () => {
            ...
            expect(result.success).toBe(true);
            expect(result.crossDirectory).toBe(true);
        });
    });
    ...
    describe('Create Folder', () => {
        ...
        it('should create folders recursively', async () => {
            ...
            expect(result.success).toBe(true);
            expect(result.createdParents).toHaveLength(3);
        });
        ...
        it('should validate all parameter types', async () => {
            const testCases = [
                ...
                },
                {
                    ...
                    params: { path: { invalid: 'object' } }
                }
            ];

            for (const testCase of testCases) {
                await expect(
                    (fileService as any)[testCase.method](mockEvent, testCase.params)
                ).rejects.toThrow();
            }
        });
    });
