...
describe("WorkerPool", () => {
    ...
    beforeEach(() => {
        ...
        (WorkerPool as any).instance = undefined;
    ...
    describe("Worker Type Registration", () => {
        it("should register a new worker type", () => {
            ...
            workerPool.registerWorkerType("TestWorker", config);

            // Should not throw and should log registration
            const logger = jest.mocked(require("../../logger"));
        ...
        it("should set default values for optional config", () => {
            ...
            workerPool.registerWorkerType("SimpleWorker", config);
    ...
    describe("Worker Execution", () => {
        beforeEach(() => {
            workerPool.registerWorkerType("ExecutionWorker", {
    ...
    describe("Worker Pool Management", () => {
        beforeEach(() => {
            workerPool.registerWorkerType("PoolWorker", {
    ...
    describe("Worker Cleanup", () => {
        beforeEach(() => {
            workerPool.registerWorkerType("CleanupWorker", {
            ...
            mockWorkerInstance.on.mockImplementation(
                (event: string, handler: any) => {
                    if (event === "message") {
                        ...
                        setTimeout(() => {
                            const sentMessage = mockWorkerInstance.postMessage
                                .mock.calls[0][0] as WorkerRequest;
