...
import { MoziEngine, type MoziEngineDeps } from "./MoziEngine"
...
describe("MoziEngine", () => {
    ...
    describe("initialization", () => {
        it("should initialize successfully", async () => {
            ...
            expect(mockLogger.info).toHaveBeenCalledWith("墨子同步引擎初始化完成")
        })

        it("should cleanup successfully", async () => {
            await engine.cleanup()
            expect(mockLogger.info).toHaveBeenCalledWith("墨子同步引擎清理完成")
        })
    })
