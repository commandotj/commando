...
const FileContextMenu: React.FC<FileContextMenuProps> = ({
    ...
    const otherPanePath = useAppSelector((state) => 
        state.fileManager.panes[otherPaneIndex].currentPath
    );
    ...
    const handleCopyToOtherPane = async () => {
    ...
    const handleMoveToOtherPane = async () => {
        if (hasSelection) {
            try {
                    ...
                    {hasSelection && (
                        <>
                            ...
                            >
                                ...
                                Cut ({selectedFiles.length} item{selectedFiles.length > 1 ? 's' : ''})
                            </ContextMenu.Item>
