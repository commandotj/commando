    ...
    Object.defineProperty(window, 'getComputedStyle', {
        value: () => ({
            getPropertyValue: (prop: string) => {
                if (prop === 'overflow' || prop === 'overflow-y' || prop === 'overflow-x') {
                    return 'auto';
                }
                return '';
            },
...
describe('FilePane', () => {
    ...
    beforeEach(() => {
        ...
        (redux.useAppSelector as jest.Mock).mockImplementation((fn) => fn(store.getState()));
    ...
    describe('Drag and Drop', () => {
        it('renders draggable file items', () => {
            ...
            expect(fileItem.closest('[data-draggable="true"]')).toBeInTheDocument();
        });
        ...
        it('renders droppable folder items', () => {
            ...
            expect(folderItem.closest('[data-droppable="true"]')).toBeInTheDocument();
        });
