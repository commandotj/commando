...
describe("ClipboardService", () => {
    ...
    describe("paste", () => {
        ...
        it("should throw error for cut operations (not yet implemented)", async () => {
            ...
            await expect(clipboardService.paste("/target", 1)).rejects.toThrow(
        ...
        it("should throw error when target path is invalid", async () => {
            ...
            await expect(clipboardService.paste("", 1)).rejects.toThrow(
                "Cannot paste: clipboard is empty or target is invalid"
            )
        })
        ...
        it("should propagate file operation errors", async () => {
            ...
            await expect(clipboardService.paste("/target", 1)).rejects.toThrow("File operation failed")
        })
    })
    ...
    describe("canPaste", () => {
        ...
        it("should return false for invalid target path", () => {
            ...
            expect(clipboardService.canPaste(null as unknown as string)).toBe(false)
        })
