...
import type { Entry, ListOptions, NavigationResult as WailsNavigationResult } from "../../bindings/github.com/systembug/commando/internal/file/models.js";
...
function toDriveInfo(info: Info): DriveInfo {
  return {
    ...
    mountpoints: (info.mountpoints ?? [])
      .filter((mountpoint): mountpoint is Record<string, string | undefined> =>
        mountpoint != null,
      )
